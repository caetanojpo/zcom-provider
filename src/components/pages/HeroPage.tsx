...
function HeroPage() {
  ...
  return (
    <main
      ...
      className={'h-dvh bg-gradient-to-br from-dark via-zcom-700 to-zcom-500 relative'}
    >
      <div
    ...
    ${animationStarted ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}
        aria-hidden="true"
      >
        <Image src="/images/hero/lines-hero.webp" alt="" fill priority />
      </div>
    ...
    ${animationStarted ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}
      ...
      >
        ...
        <section
          className="w-full sm:w-auto flex-shrink-0 z-20"
